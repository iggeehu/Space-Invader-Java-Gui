...
public class Game{
    ...
    //the constructor inits the grid with only the player, the render() method renders the enemies (based on the deadEnemiesIndex state/attribute)
    ...
    public void renderGrid() {
        ...
        //mapping each enemy array onto the grid based on relativelocX and relativelocY
